jQuery(document).ready(function($) {
	...
	$(".depth-3").children(".children").find(".reply").click(function() {
		var _1 = $(this).parent().attr("id");
		var _2 = $(this).parents(".comment-body").find(".vcard-uid").text();
		$("#comment").attr("value", "<a href='#" + _1 + "'>@" + _2 + "</a> ").slider()
	});
...
jQuery(document).ready(function($) {
	$(".commentmeta img,.post-content img").lazyload({
		placeholder: "http://wp.cdn.gongzi.org/gztro/img/grey.gif",
		effect: "fadeIn"
	})
});
...
jQuery(document).ready(function() {
	jQuery(".mynav ul li").hover(function() {
		jQuery(this).children("ul").show();
		jQuery(this).addClass("lione");
	},
	function() {
		jQuery(this).children("ul").hide();
		jQuery(this).removeClass("lione");
	});
});
jQuery(document).ready(function() {
...
jQuery(document).ready(function() {
	jQuery("a[rel='external'],a[rel='external']").click(function() {
